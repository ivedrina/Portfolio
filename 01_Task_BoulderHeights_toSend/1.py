...
poly = gpd.read_file(r'01_Task_BoulderHeights_toSend\Boulder polygons\Test_Manually_Picked_Boulders.shp')
...
src = rasterio.open(r'01_Task_BoulderHeights_toSend\MBES grid\Test_Encoded_Depths_File.tif')
...
print(type(poly_centroid['WaterDepth']))
...
poly_s = shapefile.Reader(r'01_Task_BoulderHeights_toSend\Boulder polygons\Test_Manually_Picked_Boulders.shp')
...
poly_centroid['TargetID']='MBES_'+ block_number +'_' +poly_centroid['Poly_ID'].apply(str)
poly_centroid['Block'] = 'B'+ block_number
...
#writting data to outpt file
poly_centroid.to_file(r'01_Task_BoulderHeights_toSend\Boulder polygons\output.shp')


polyOutput = gpd.read_file(r'01_Task_BoulderHeights_toSend\Boulder polygons\output.shp')
print(polyOutput)
